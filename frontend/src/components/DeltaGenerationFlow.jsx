                        ...
                        <div className="space-y-3">
                            ...
                            {keyRules.length === 0 && (
                                <div className="text-center text-gray-500 py-4">
                                    ...
                                    <p className="text-xs">Add key rules to define how records should be matched between files.</p>
                                </div>
                            )}
                        </div>
                    </div>
            ...
            return (
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-600">Define fields to compare for detecting amendments. Records with matching keys but different optional fields will be marked as "Amended".</p>
                    </div>
