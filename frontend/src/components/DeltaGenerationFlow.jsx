        ...
        switch (currentStep) {
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
                            ...
                            <ul className="mt-2 ml-4 list-disc space-y-1">
                                <li><strong>Identify Unchanged:</strong> Records with same keys and same optional fields</li>
                                <li><strong>Identify Amended:</strong> Records with same keys but different optional fields</li>
                ...
                return (
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Define the key fields that uniquely identify records for matching between files. These form a composite key.</p>
                        </div>
                            ...
                            <div className="space-y-3">
                                    ...
                                    return (
                                        <div key={ruleIndex} className="p-3 bg-blue-50 rounded border border-blue-200">
                                            <div className="grid grid-cols-4 gap-3 mb-3">
                                                <div>
                                                    <label className="block text-xs font-medium text-gray-700 mb-1">Older File Column</label>
                                                    <select
                                                ...
                                                <div>
                                                    <label className="block text-xs font-medium text-gray-700 mb-1">Newer File Column</label>
                                                    <select
                                ...
                                {keyRules.length === 0 && (
                                    <div className="text-center text-gray-500 py-4">
                                        ...
                                        <p className="text-xs">Click "Add Key Rule" to define composite key fields.</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        {keyRules.length > 0 && (
                            <div className="text-sm text-gray-600 bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                                <p><strong>Composite Key Preview:</strong></p>
                                <p className="mt-1 font-mono text-xs">
                                    {keyRules.map(rule => `${rule.LeftFileColumn || '[Field]'}`).join(' + ')}
                                    <span className="text-gray-500"> matches with </span>
                                    {keyRules.map(rule => `${rule.RightFileColumn || '[Field]'}`).join(' + ')}
                                </p>
                            </div>
                        )}
                    </div>
            ...
            case 'comparison_rules':
                return (
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold text-gray-800">Optional Fields for Comparison</h3>
                            <p className="text-sm text-gray-600">Define optional fields to compare for records with matching keys. If these fields differ, the record will be marked as "Amended".</p>
                        </div>
                        ...
                        <div className="p-4 border border-gray-200 rounded-lg">
                            ...
                            <div className="space-y-3">
                                {comparisonRules.map((rule, ruleIndex) => {
                                    ...
                                    return (
                                        <div key={ruleIndex} className="p-3 bg-green-50 rounded border border-green-200">
                                            <div className="grid grid-cols-4 gap-3 mb-3">
                                                <div>
                                                    <label className="block text-xs font-medium text-gray-700 mb-1">Older File Column</label>
                                                    <select
                                ...
                                {comparisonRules.length === 0 && (
                                    <div className="text-center text-gray-500 py-4">
                                        ...
                                        <p className="text-xs">Optional: Add rules to compare specific fields for amendments.</p>
                                        <p className="text-xs mt-1 text-yellow-600">If no comparison rules are defined, records with matching keys will be considered "Unchanged".</p>
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                return (
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Choose which columns from each file should be included in the delta results. Key and comparison rule columns are automatically included.</p>
                        </div>
                            ...
                            <div className="p-4 border border-blue-200 bg-blue-50 rounded-lg">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <h4 className="text-md font-medium text-blue-800">Older File: {getFileByIndex(0)?.filename}</h4>
                                    </div>
                                ...
                                <div className="space-y-2 max-h-60 overflow-y-auto">
                                    ...
                                    {getMandatoryColumns(0).length > 0 && (
                                        <>
                                            <div className="text-xs font-medium text-blue-700 mb-2">Required Columns (Auto-included):</div>
                                    ...
                                    {getOptionalColumns(0).length > 0 && (
                                        <>
                                            <div className="text-xs font-medium text-blue-700 mb-2 mt-4">Optional Columns:</div>
                            ...
                            <div className="p-4 border border-green-200 bg-green-50 rounded-lg">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <h4 className="text-md font-medium text-green-800">Newer File: {getFileByIndex(1)?.filename}</h4>
                                    </div>
                                    <div className="flex space-x-2">
                                        <button
                        ...
                        <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
                            <p><strong>Note:</strong> Key and comparison rule columns are automatically included and cannot be deselected. Selected columns will be prefixed with "FileA_" or "FileB_" in the delta output.</p>
                        </div>
                    </div>
                );
                ...
                return (
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Review your delta generation configuration before proceeding.</p>
                        </div>
                        ...
                        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                {filesArray.slice(0, 2).map((file, index) => (
                                    <div key={index}>
                                        <span className="font-medium">{index === 0 ? 'Older File (A)' : 'Newer File (B)'}:</span> {file?.filename}
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                            <h4 className="font-medium text-purple-800 mb-2">Key Rules (Composite Key)</h4>
                            <div className="space-y-2 text-sm">
                                {keyRules.length > 0 ? (
                                    <ul className="space-y-1">
                                        {keyRules.map((rule, index) => (
                                            <li key={index} className="text-xs">
                                                Key {index + 1}: "{rule.LeftFileColumn}" matches "{rule.RightFileColumn}" using {rule.MatchType}
                                ...
                                {comparisonRules.length > 0 ? (
                                    <ul className="space-y-1">
                                        {comparisonRules.map((rule, index) => (
                                            <li key={index} className="text-xs">
                                                Compare "{rule.LeftFileColumn}" with "{rule.RightFileColumn}" using {rule.MatchType}
                                                {rule.MatchType === 'numeric_tolerance' && rule.ToleranceValue && ` (tolerance: ${rule.ToleranceValue}%)`}
                                            </li>
                                        ))}
                                    </ul>
                        ...
                        <div className="p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    <span className="font-medium text-indigo-700">Older File Columns:</span>
                                ...
                                <div>
                                    <span className="font-medium text-indigo-700">Newer File Columns:</span>
                                    <div className="ml-2 text-xs">
                                        <div className="text-indigo-600 mb-1">
                        ...
                        <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                            ...
                            <div className="text-xs space-y-1">
                                <p><strong>🔑 Key Matching:</strong> Records are matched using composite key from {keyRules.length} key rule{keyRules.length !== 1 ? 's' : ''}</p>
                                <p><strong>📊 Comparison:</strong> {comparisonRules.length > 0 ? `${comparisonRules.length} field${comparisonRules.length !== 1 ? 's' : ''} will be compared for amendments` : 'No field comparison - matching keys = unchanged'}</p>
                        ...
                        <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                            ...
                            <div className="space-y-1 text-sm">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Check size={16} className="text-green-500"/>
                                    <span>Comparison rules {comparisonRules.length > 0 ? 'configured' : '(optional)'}</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Check size={16} className="text-green-500"/>
